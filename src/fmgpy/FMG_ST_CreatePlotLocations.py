...
##inStand = arcpy.GetParameterAsText(8)
...
### Attach POOL COMP UNIT SITE STAND IDs - need to figure out how to order this correctly and need to remove the extra join fields included
