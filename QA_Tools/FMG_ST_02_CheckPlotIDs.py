...
FC_Main = arcpy.GetParameterAsText(0)
Main_PlotID_Field = arcpy.GetParameterAsText(1)
FC_Check = arcpy.GetParameterAsText(2)
Check_PlotID_Field = arcpy.GetParameterAsText(3)

# Check PlotIDs
FMG_QA_FunctionLibrary.check_Plot_IDs(FC_Master=FC_Main,
                                      Master_PlotID_Field=Main_PlotID_Field,
                                      FC_Check=FC_Check,
